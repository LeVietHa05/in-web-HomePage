        ...
        <div className="bg-[#407EFF] w-full rounded-[32px] lg:rounded-[60px]  relative z-2  overflow-x-hidden overflow-y-hidden -mt-12 border-12 lg:border-24 border-[#004DEE]">
            ...
            <div className="flex items-center">
                ...
                <div className="flex items-center justify-center flex-1 ">
                    <div className="p-2 lg:p-4 border border-[#FDFFD6] rounded-[32px] lg:rounded-[60px] relative">
                        ...
                        <div className="absolute -right-3 lg:left-9/10 -bottom-3 lg:-bottom-10 animate-bounce size-10 lg:size-32">
                            <Image className="" src={'/mouse.png'} alt="" width={110} height={110}></Image>
                        </div>
                    </div>
                </div>
            </div>
