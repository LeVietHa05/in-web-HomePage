...
export default function Doingumentor({ imglink, color1, color2 }: { imglink: string, color1: string, color2: string }) {
    return (
        <div className="bg-[#3253BC] w-full rounded-[32px] lg:rounded-[60px]  relative z-2 overflow-hidden -mt-24 pt-12 lg:pt-24 lg:pb-24 ">
            <div className={`${SVNHelveticaNeueHeavy.className} text-[72px] lg:text-[196px] text-center`} style={{ color: color1 }}>
                ĐỘI NGŨ<br></br>MENTOR
            </div>
            <div style={{ backgroundColor: color1, color: color2 }} className=" flex gap-6 lg:gap-8 lg:w-[1080px] mx-auto p-4 lg:p-8 text-justify text-[14px] lg:text-[20px] lg:-mt-14 relative rounded-lg">
                <div className="absolute bottom-1/1 left-1/2 -translate-x-1/2 ">
                    <Image src={imglink} alt="" width={386} height={518} className="w-40 lg:w-96"></Image>
                </div>
