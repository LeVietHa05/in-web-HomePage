...
export default function Nav() {
  ...
  return (
    <nav className="fixed top-0 w-full z-[1000] bg-[#001E7F] rounded-b-lg lg:rounded-b-2xl 2xl:rounded-b-4xl">
      <div className="max-w-[1440px] mx-auto p-2 xl:px-5 xl:py-4 flex items-center justify-between text-white font-bold font-[Helvetica] text-xs  xl:text-sm text-base">
        ...
        {/* DESKTOP */}
        <div className="hidden lg:flex items-center space-x-2 lg:space-x-3 2xl:space-x-6 translate-y-1/7 ">
          {navitems.map((e, i) => (
