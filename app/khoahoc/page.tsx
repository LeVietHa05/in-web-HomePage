...
export default function KhoaHocBoTro() {
  return (
    <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[2.2fr_1fr] gap-12 items-center w-full">
            <div>
              ...
              <div className="flex flex-wrap justify-center gap-6 max-w-[520px]">
                <Link href="/khoahoc/college-prep" className="px-8 py-3 rounded-full bg-[#407EFF] text-[#FEFFB7] lg:text-[18px] font-semibold font-montserrat shadow-[1.864px_1.864px_3.729px_rgba(0,0,0,0.7)] hover:scale-105 transition">
                  KHÓA COLLEGE PREP
                </Link>

                <Link href="/khoahoc/ielts" className="px-8 py-3 rounded-full bg-[#407EFF] text-[#FEFFB7] lg:text-[18px] font-semibold font-montserrat shadow-[1.864px_1.864px_3.729px_rgba(0,0,0,0.7)] hover:scale-105 transition">
                  LUYỆN THI IELTS
                </Link>

                <Link href="/khoahoc/creative-writing" className="px-8 py-3 rounded-full bg-[#407EFF] text-[#FEFFB7] lg:text-[18px] font-semibold font-montserrat shadow-[1.864px_1.864px_3.729px_rgba(0,0,0,0.7)] hover:scale-105 transition">
      ...
      <div className="relative bg-[#BFE4FF] rounded-full lg:rounded-[40px] mx-auto max-w-[1440px] py-4 lg:py-16 z-100 -mt-[60px]">
        <h2 className={`${SVNHelveticaNeueHeavy.className} text-center text-[#3253BC] text-2xl md:text-[32px] lg:text-[60px] font-black leading-normal`}>
          ĐỘI NGŨ GIẢNG VIÊN
        </h2>
      </div>
      <div className="w-full bg-[#3253BC] py-30 -mt-20">
        <div className="max-w-[1200px] mx-auto px-2 lg:px-6 flex flex-col items-center gap-14 overflow-hidden">
          ...
          <div className="w-full bg-[#ADDDFF] px-4 md:px-10 py-3 md:py-8 -mt-25 text-[#004DEE] text-xs md:text-base lg:text-[20px] font-[700] text-justify leading-normal font-['Helvetica']">
