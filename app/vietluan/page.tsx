...
export default function Vietluan() {
    return (
        <div className="max-w-[1440px] mx-auto relative">
            ...
            <div className="relative h-screen max-h-[840px] w-full z-0">
                ...
                <div className="relative top-1/2 left-1/2 -translate-1/2 flex w-fit">
                    <div className="flex flex-col justify-around pl-20">
                        <div>
                            <div className={`${SVNHelveticaNeueHeavy.className} text-[48px] text-[#FFF175] mb-4`}>
                                CHINH PHỤC HỌC BỔNG DU HỌC <br />
                                VỚI BÀI LUẬN CÁ NHÂN HOÁ
                            </div>
                            <div className="text-[#EAFDFF]  text-[28px]">
            ...
            <div className="bg-[#FDFFD6] min-h-[1450px] -mt-24 pt-50 relative z-1 rounded-[60px] text-[#004DEE]">
                ...
                <div>
                    <div className={`max-w-[1080px] mx-auto bg-[#FFF175] font-bold  rounded-[30px] p-4 pb-8`}>
                        ...
                        <div>
                            <ul className="list-disc ml-24 text-xl font-bold pr-12">
            ...
            <div className="bg-[#FFF175] relative z-1 -mt-24 pt-40 pb-20 rounded-[60px] text-[#004DEE]">
